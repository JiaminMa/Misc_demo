...
static void ecc_point_decompress(EccPoint *p_point, const uint8_t p_compressed[ECC_BYTES * 2])
{
    uint64_t _3[NUM_ECC_DIGITS] = {3}; /* -a = 3 */
    ecc_bytes2native(p_point->x, p_compressed);
    ecc_bytes2native(p_point->y, p_compressed + ECC_BYTES);
#if 0
